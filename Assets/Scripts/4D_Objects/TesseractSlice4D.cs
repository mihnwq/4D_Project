...
public class TesseractSlice4D : _4D_Object
{
    ...
    public void OnValidate()
    {
        ...
        objectProprieties.Add(new Array2_List("size", size.ToString()));
        objectProprieties.Add(new Array2_List("sliceThickness", sliceThickness.ToString()));
        objectProprieties.Add(new Array2_List("wSlice", wSlice.ToString()));
    }
    ...
    protected override void Update()
    {
        ...
        objectProprieties[0].GetValueInto(ref size);
        objectProprieties[2].GetValueInto(ref wSlice);
        objectProprieties[1].GetValueInto(ref sliceThickness);
