...
public class AnimatedHypersphereDebug : _4D_Object
{
    ...
    private void OnValidate()
    {
        ...
        objectProprieties.Add(new Array2_List("psiSegments", psiSegments.ToString()));
        objectProprieties.Add(new Array2_List("thetaSegments", thetaSegments.ToString()));
        objectProprieties.Add(new Array2_List("phiSegments", phiSegments.ToString()));
    }
    ...
    protected override void Update()
    {
        ...
        DrawHypersphere(angle * 1/2); // Each frame, draw the hypersphere with a time-dependent rotation.
    ...
    void DrawHypersphere(float t)
    {
        ...
        objectProprieties[0].GetValueInto(ref psiSegments);
        objectProprieties[1].GetValueInto(ref thetaSegments);
        objectProprieties[2].GetValueInto(ref phiSegments);
